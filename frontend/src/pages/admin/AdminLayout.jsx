...
export default function AdminLayout() {
  ...
  return (
    <div className="admin-theme admin-root h-screen overflow-hidden text-slate-800 dark:text-slate-100 font-sans flex admin-soft">
      <aside
      ...
      >
        ...
        <nav className="p-3 h-[calc(100vh-80px)] overflow-y-auto">
      ...
      <main className={`${sidebarOpen ? "md:ml-72" : "md:ml-20"} ml-0 flex-1 min-w-0 transition-all duration-300 admin-soft h-screen flex flex-col overflow-y-auto`}>
